...
pq=0
g=0
with open('functionResult_tcas_tcasMutantLine72V1.csv', 'w') as csvfile1, open('statementResult_tcas_tcasMutantLine72_V4.csv','w') as csvfile2 :
    ...
    for l1 in fp1:
        ...
        for line1 in fp2:
            try:    
                ...
                print ("exiting")		
                exit(1)
        p=filecmp.cmp("/home/jitendra/Desktop/Fault_Localization/SiemenSuite_7ProgramsAndCodeInformation/tcas/outputs/t"+str(i), "/home/jitendra/Desktop/Fault_Localization/SiemenSuite_7ProgramsAndCodeInformation/tcas/OutputsMutantLine72_V4/t"+str(i)) 
        if p==True:
